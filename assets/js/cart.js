...
async function checkoutCOD() {
  ...
  try {
    ...
    // ------ إرسال إشعار تليجرام ------
    try {
      // ⚠️ ضع التوكن والـ ID الخاص بك هنا بدل الكلمات الإنجليزية ⚠️
      const telegramBotToken = '8257694905:AAHJB41P5YAwBAeVs4MeXemSttRYtactIHo';
      const telegramChatId = '6531578379';
...
💰 *الإجمالي:* ${orderData.total_price} ج.م
      ...
      // إرسال الطلب لـ Telegram في الخلفية 
      if (telegramBotToken !== '8257694905:AAHJB41P5YAwBAeVs4MeXemSttRYtactIHo') {
      ...
      console.error('Telegram notification setup error:', e);
    }
    // ---------------------------------

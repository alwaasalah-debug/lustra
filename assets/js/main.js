    ...
    let html = `
        <li class="nav-search-item">
          <div class="nav-search-bar">
            ...
            <input type="text" id="navSearchInput" placeholder="ابحث عن سكراب..." autocomplete="off" oninput="performNavSearch()" onkeydown="if(event.key==='Enter'){event.preventDefault();performNavSearch();}">
          </div>
          <div class="nav-search-results" id="navSearchResults"></div>
        </li>
        <li><a href="index">الرئيسية</a></li>
        <li><a href="#" onclick="handleNavClick('all'); return false;">كل الاسكرابات</a></li>
    `;
